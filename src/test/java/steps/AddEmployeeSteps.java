...
public class AddEmployeeSteps extends CommonMethods {
    ...
    @When("user adds multiple employee from exel file usin {string} sheet and verify the added employee")
    public void user_adds_multiple_employee_from_exel_file_usin_sheet_and_verify_the_added_employee(String sheetName) {
